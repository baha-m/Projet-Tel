...
public class StockV extends JFrame {
	private User u;
	...
	public StockV(User u){
		this.u=u;
		this.setSize(600, 300);
		this.setTitle("Liste du Materiels");
		...
		conBDD b=new conBDD();
		b.exec_aff("Select ref,process,ram,graph,dd,det from pc where ref not in(select ref_pc from poste)", tab);
