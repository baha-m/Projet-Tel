...
public class ReservationV extends JFrame {
	private User u;
	...
	public ReservationV(User u){
		...
		conBDD b=new conBDD();
		b.exec_aff("Select REF_PREPH,to_char(DD, 'DD-MM-YYYY HH24:MI:SS'),to_char(DF, 'DD-MM-YYYY HH24:MI:SS') from reservation where ID_USER='"+u.getLog()+"'", tab);
