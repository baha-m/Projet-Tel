...
public class PereADD extends JFrame {

	private User u;
	private JPanel contentPane;
	private JLabel refLabel,prosLabel,ramLabel;
	private JTextField ref,ramt,type;
	...
	public PereADD(User u) {
		...
		//Type
				...
				panpros.setBorder(BorderFactory.createTitledBorder("Materiel"));
				pros = new JComboBox();
				//requette sql du type form TABLE
				conBDD b=new conBDD();
				String[] tab =new String[b.exec_aff_NB("Select distinct count(Type) from pereph")];
				b.exec_aff("select type from pereph", tab);
		...
		//Labelle
				...
				panram.setBorder(BorderFactory.createTitledBorder("Labelle"));
				ramt =new JTextField();
		...
		okBouton.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent arg0) {
				conBDD b=new conBDD();
				b.exec("insert into pereph values('"+ref.getText()+"','"+pros.getSelectedItem()+"','"+ramt.getText()+"','"+u.getLog()+"' )");
				setVisible(false);
			}			
		});
